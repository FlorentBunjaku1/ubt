...
public class Autosalloni {
	...
	public boolean exist(Automjeti at){
		  ...
		  public void shtoNjeAutomjet(String nrShasise, String prodhuesi, int vitiProdhimit,  boolean eshteAutomatik) {
			  Automjeti nauto = new Automjeti(nrShasise, prodhuesi, vitiProdhimit) {
				  public boolean eshteAutomatik() {
					  return eshteAutomatik;
				  }
			  };
			  shtoAutomjetin(nauto);
		  }
		  public void shtoPrototipin(String nrShasise, String prodhuesi) {
			  class Prototipi extends Automjeti {
				  public Prototipi(String nrShasise ,String prodhuesi) {
					  super(nrShasise,prodhuesi,2020);
				  }
				  public boolean eshteAutomatik() {
					  return false;
				  }
			  ...
			  if(kaPrototip) {
				  System.out.println("Nuk lejohen me shume se nje prototip");
			  }else {
			  Prototipi nproto = new Prototipi(nrShasise, prodhuesi);
				if(kaPrototip == false){
			  	shtoAutomjetin(nproto);
			  	kaPrototip = true;
				}
			  }
		  }
	...
	public static void main(String[] args) {
		...
		salloni.shtoNjeAutomjet("NP12345", "Honda", 2019, true);
		salloni.shtoPrototipin("ProtoP1234", "Proto");
		salloni.shtoPrototipin("ProtoP12346", "Proto2");
