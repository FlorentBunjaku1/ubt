...
public class Fakulteti{
	...
	//===================Methods===================================================//
		...
		public void shtoNjeMesimdhenes(String emri, int vitiLindjes,String angazhimi, boolean mentoron) {
			Mesimdhenesi nms = new Mesimdhenesi(emri,vitiLindjes,angazhimi) {
				public boolean mentoron() {
					return mentoron;
				}
			};
			shtoMesimdhenesin(nms);
		}
		public void shtoDekanin(String emri, int vitiLindjes) {
			...
			Dekani d = new Dekani(emri,vitiLindjes);
			
			if(kaDekan) {
				System.out.println("Nuk mund te ket dy Dekana");
				return;
			}
			if(index == m.length) {
				System.out.println("Nuk ka vend ne varg");
	...
	public static void main(String[] args) {
          ...
          f.shtoNjeMesimdhenes("Filan Meimdhenesi1", 1998, "Ligjerata", true);
          f.shtoDekanin("Filan Dekani", 1998);
