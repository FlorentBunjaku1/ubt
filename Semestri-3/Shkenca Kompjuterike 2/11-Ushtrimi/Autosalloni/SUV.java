public class SUV extends Automjeti{
	  ...
	  public SUV(String nrShasise, String prodhuesi, int vitiProdhimit,boolean eshte4x4) throws AutomjetiException{
...
//	  Implementimi i metodes numriShpejtesive te trasheguar nga interface
	  @Override
