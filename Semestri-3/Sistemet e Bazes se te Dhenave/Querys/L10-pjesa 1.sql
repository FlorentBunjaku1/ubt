...
--T� gjeni cilet punonj�s b�jn� t� njejten pun� me at� t� punonj�sit me ID '110'.

Select e1.first_name 'Emri', e1.last_name, j.job_id 'IDPunes', j.job_title'Titulli Punes'
from employees e1 JOIN jobs j
	on j.job_id=e1.job_id
where e1.job_id =(Select e.job_id 'IDPunonjesit'
				  from employees e
...
/*Te listoni menagjmeret e departamenteve perkatese , duke perfshire te dhenat e tyre departamenti
dhe titullin e punes id e menagjerit*/


--Kodi jem qe spunon---
Select e1.employee_id, e1.first_name, e1.last_name, d1.department_name, d1.department_id, e1.manager_id, j.job_title
From jobs j JOIN employees e1 ON j.job_id = e1.job_id
	 JOIN departments d1 on d1.department_id = e1.department_id
Where e1.employee_id IN  (Select DISTINCT (e.manager_id )-- e.first_name, e.last_name, e.department_id, m.manager_id
...
--Kodi profes---
Select e1.employee_id, e1.first_name, e1.last_name, d1.department_name, d1.department_id, e1.manager_id, j.job_title
From Jobs j JOIN employees e1
	on j.job_id=e1.job_id
	JOIN departments d1
	on d1.department_id=e1.department_id
where e1.employee_id IN (select distinct (m.manager_id)--e.first_name, e.last_name,e.department_id,m.manager_id
...
Select e1.first_name, e1.last_name, e1.salary, d1.department_name
From employees e1 join departments d1 on e1.department_id = d1.department_id
Where e1.salary >ANY (Select AVG(e.salary) as 'Paga Mesatare'
					From employees e
